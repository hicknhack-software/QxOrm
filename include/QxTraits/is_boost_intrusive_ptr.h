 ...
 */
template <typename T>
class is_boost_intrusive_ptr
{

private:

   template <typename V> static char isSmartPtr(boost::intrusive_ptr<V>);
...
public:
   ...
   typedef typename boost::mpl::if_c<qx::trait::is_boost_intrusive_ptr<T>::value,
                                     boost::mpl::true_,
